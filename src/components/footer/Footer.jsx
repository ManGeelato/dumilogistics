  ...
  return (
    <div className="container-fluid" id="footerPage">
      ...
      <div id="footerRightCard">
        <small>All Rights Reserved &copy; Skinny Tours 2024. Developed by <a href="https://emmanuelkaome-mangeelato.vercel.app/" target="_blank">Emmanuel 'Gadaffi' Kaome</a></small>
      </div>
    </div>
  );
}
